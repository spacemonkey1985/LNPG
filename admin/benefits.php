    ...
    <div class="content">
    	<div class="content-content">
            ...
            <div class="members-menu">
            	<ul>
                	<li class="selected"><a href="benefits.php">View</a></li>
                	<li><a href="benefits-edit.php">New / Edit</a></li>
                </ul>
            </div>
                	...
                	<h1>Member benefits</h1>
       				...
       				<p>
                        ...
                        <?php
							...
							$benefits = "SELECT * FROM empg_benefits;";
							...
							if(!$result = mysql_query($benefits)){
								...
								while($row = mysql_fetch_array($result)){
									if($i%2 == 1){
										...
										echo("<div style='height: 45px; color: #ffffff; background-color: #7aba0c; padding: 3px; font-size: 18px;'><b>" . $row['Title'] . "</b></div>");
										echo("<div style='padding: 3px; color: #fff;'>" . $row['Description'] . "</div>");
										echo("<div style='margin-top: 10px; padding: 3px; text-align: right; line-height: 24px; vertical-align: middle; color: #fff;'><a href='benefits-edit.php?id=" . $row['BenefitId'] . "'><img src='../images/edit-btn.png' alt='Contact us' style='float: right; margin-left: 5px; padding-right: 15px;' />Edit</a></div>");
										echo("</div>");
									}
									else{
