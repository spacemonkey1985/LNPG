...
Peter Francis';
		...
		mail($to.',admin@lnpg.co.uk', $subject, $body, 'From: ' . MAILADDR_MEMBERSHIP );
	}
...
<body>
    ...
    <div id="boxes">
    	<div id="activated" class="window">
        	<a href="members-paid.php" class="close"><img src="../images/modal/modal-top.png" /></a>
    	...
    	<div class="content-content">
            ...
            <div class="members-menu">
            	<ul>
                	...
                	<li class="selected"><a href="members-paid.php">Unactivated</a></li>
            ...
            <div class="members-content">
            	<div style="position: relative; float: left; font-size: 12px; width: 665px; margin-left: 20px;">
                	<div style="float: right; line-height: 24px;">
                    	<a href="members-export.php?type=paid" target="_blank"><img src="../images/export-btn.png" alt="Export" style="padding-right: 15px; vertical-align: middle;" />Export</a>
                    </div>
       				...
       				<p>
                        ...
                        <table cellpadding="3" class="member-list">
                            <tr>
                                ...
                                <td width="80px"><b>Date Paid</b></td>
                                <td colspan="3"></td>
                            </tr>
                            
                            <?php
                                
                                $members = "SELECT * FROM empg_member WHERE PaymentDate is not null;";
								...
								if(!$result = mysql_query($members)){
									...
									while($row = mysql_fetch_array($result)){
										...
										if($row['PaymentDate'] == '' || $row['PaymentDate'] ==  null)
										{
											echo("<td style='vertical-align: top;'></td>");
										}
										else
										{
											echo("<td style='vertical-align: top;'>" . date_format(date_create($row['PaymentDate']), 'd-m-Y') . "</td>");
										}
										...
										if($row['Active'] == 1){
											echo("<td style='vertical-align: top; text-align: center;'><a href='members-paid.php?deactivate=" . $row['MemberNo'] . "'><img src='../images/deactivate-btn.png' alt='Deactivate' title='Deactivate member' style='border: none;' /></a></td>");
										}
										else{
											echo("<td style='vertical-align: top; text-align: center;'><a href='members-paid.php?activate=" . $row['MemberNo'] . "'><img src='../images/activate-btn.png' alt='Activate' title='Activate member' style='border: none;' /></a></td>");
										}
										
										echo("<td style='vertical-align: top; text-align: center;'><a href='members-paid.php?email=" . $row['MemberNo'] . "'><img src='../images/mail-btn.png' alt='Send email' title='Send email' style='border: none;' /></a></td>");
