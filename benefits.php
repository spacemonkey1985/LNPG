...
<body>
    ...
    <div class="title-banner">
    	<div class="title-banner-content">
			...
			<img src="images/benefits-title.png" alt="Member benefits" />
    	...
    	<div class="content-content">
            ...
            <div class="right-column">
                ...
                <div class="benefits-subtitle">
                	Welcome to our<br />member benefits<br />area
				</div>
                        ...
                        if(!$result = mysql_query($benefits)){
                            ...
                            while($row = mysql_fetch_array($result)){
								if($i%2 == 1){
									...
									echo("<div style='padding: 3px;'>" . $row['Description'] . "</div>");
									echo("<div style='margin-top: 10px; padding: 3px; text-align: right; line-height: 30px; vertical-align: middle;'>Would you like this benefit?<a href='join.php'><img src='images/join-now-btn.png' alt='Join Now' style='float: right; margin-left: 5px;' /></a></div>");
									echo("</div>");
								}
								else{
